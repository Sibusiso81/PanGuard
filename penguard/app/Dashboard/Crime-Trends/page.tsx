...
import { ViolenceTrend } from "./violence-trend";
import { MurderTrend } from "./murder-trend";
import { HouseHoldTrend } from "./household-crime";
import { SexualOffencesForecast } from "./sexual-offencies-forecast";
import { MurderCrimeForecast } from "./murder-crime-forecast";
import { AssaultGBVForecast } from "./assult-gbv-forecast";
        ...
        <div className="flex flex-1 flex-col justify-center">
          <div className="@container/main flex flex-1 flex-col gap-2">
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
              ...
              <h2 className="text-2xl lg:text-4xl font-bold px-4">
                Forecasts{" "}
              </h2>
              <div className="grid gap-4 px-4 lg:px-6 md:grid-cols-2 lg:grid-cols-3  ">
                <SexualOffencesForecast />
                <MurderCrimeForecast />
                <AssaultGBVForecast />
              </div>
            </div>
